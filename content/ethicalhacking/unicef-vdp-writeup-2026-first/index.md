...
<img src="./images/unicefinfosechalloffame.png" alt="UNICEF VDP" class="img-fluid rounded mb-4" style="max-width:720px; width:auto; display:block;" width="720" height="405" loading="lazy" decoding="async">
</a>
</div>
...
![Dork Results](/images/dorkresults1.png)
...
![ArcGIS Server](/images/appendblz.png)
...
![ArcGIS Cannot Upload](/images/cannotupload.png)
...
```txt
site:*.unicef.* inurl:"/FeatureServer/uploads"
```

![Dork Results 2](/images/dorkresults2.png)
...
![Upload Endpoint](/images/uploadsendpoint.png)
...
![Upload Item](/images/uploaditem.png)

![Browse File](/images/browsefile.png)
...
![Successful Upload](/images/ethicalhack.png)
...
![Verify Upload](/images/proofhack.png)
...
![JSON Format](/images/jsonethicalhack.png)
...
![UNICEF Email](/images/unicefinfosecemailreply.png)
