...
<img src="./images/whitehatsforsciencekudos2.png" alt="LBNL VDP" class="img-fluid rounded mb-4" style="max-width:720px; width:auto; display:block;" width="720" height="405" loading="lazy" decoding="async">
</a>
</div>
...
![LBNL Underlined Search](/images/underlinesearch.png)

<p class="lead mb-4">The result was clear. HTML injection was working.</p> 

![LBNL CloudFlare WAF](/images/cloudflarecslblgov.png)
...
![LBNL Iframe Sources](/images/iframesources.png)
...
![LBNL Phishing Page Centered](/images/phishingcentered.png)
...
![LBNL Django Email Reply](/images/secondemailreply.png)
