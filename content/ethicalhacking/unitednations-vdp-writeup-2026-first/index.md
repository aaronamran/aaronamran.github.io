...
<img src="./images/unitednations_infosec_halloffame.png" alt="UN Infosec Hall of Fame" class="img-fluid rounded mb-4" style="max-width:720px; width:auto; display:block;" width="720" height="405" loading="lazy" decoding="async">
</a>
</div>
...
<img src="./images/unitednations_infosec_halloffame1.png" alt="UN Infosec Hall of Fame" class="img-fluid rounded mb-4" style="max-width:720px; width:auto; display:block;" width="720" height="405" loading="lazy" decoding="async">
</a>
</div>
...
![Apache Solr Admin UI](/images/solrreleaseadminui.png)
...
![Apache Solr Log4j](/images/solrreleaselogging.png)

![Apache Solr Security](/images/solrreleasesecurity.png)

<p class="lead mb-4">Clicking on the security tab, as seen in the next screenshot, proves that my instincts were right.</p>

![Apache Solr Core Admin](/images/solrreleasecoreadmin.png)

![Apache Solr Java Properties](/images/solrreleasejavaproperties.png)

![Apache Solr Thread Dump](/images/solrreleasethreaddump.png)
...
![Apache Solr Unload Core](/images/solrreleaseunloadcore.png)
...
![OICT Infosec Email 1](/images/oictinfosec_firstemail.png)
...
![OICT Infosec Email 2](/images/oictinfosec_secondemail.png)
...
![UN Global Compact Email 1](/images/unglobalcompact_firstemail.png)
...
![UN Global Compact Email 2](/images/unglobalcompact_secondemail.png)
...
![Dork Results](/images/unocha_restservices_googledork.png)
...
![Upload Malicious Item PoC](/images/sdn_sudan_featureserver_uploaditem_true.png)
...
![OICT Infosec Email 3](/images/oictinfosec_thirdemail.png)
