...
<img src="./images/whitehatsforsciencekudos3.png" alt="LBNL VDP" class="img-fluid rounded mb-4" style="max-width:720px; width:auto; display:block;" width="720" height="405" loading="lazy" decoding="async">
</a>
</div>
...
![LBNL CR1000X Datalogger Status Homepage](/images/cr1000x_status_homepage.png)
...
![LBNL CR1000X Datalogger Sign-In Prompt](/images/cr1000x_signin.png)
...
![LBNL CR1000X Datalogger File Control](/images/cr1000x_file_control.png)
...
![LBNL CR1000X Datalogger Utilities](/images/cr1000x_utilities.png)
...
![LBNL CR1000X Datalogger Product Image](/images/cr1000x_product_image.png)

![LBNL CR1000X Datalogger Product Details](/images/cr1000x_product_details.png)
...
![LBNL CR1000X Email Reply](/images/thirdvulnemailreply.png)
...
<a href="https://labpartnering.org/success-stories/0ea93456-f4fa-4b00-a083-8eea524eea36?labs%5B%5D=lbnl" target="_blank" referrerpolicy="noreferrer"><img src="./images/berkeleylab_zeek.png" alt="Berkeley Lab Zeek" class="img-fluid rounded mb-4" style="max-width: 720px;" width="720" height="405" loading="lazy" decoding="async"></a>
