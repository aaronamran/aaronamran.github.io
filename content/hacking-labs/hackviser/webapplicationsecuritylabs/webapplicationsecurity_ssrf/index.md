...
<h5 class="mb-2"><strong>1. Basic SSRF</strong></h5>
<p class="mb-3">This lab contains a Server-Side Request Forgery (SSRF) vulnerability in a PHP-based web application. To complete the lab, exploit the SSRF vulnerability in the URL parameter to obtain the server's hostname information. What is the server's hostname?</p>
